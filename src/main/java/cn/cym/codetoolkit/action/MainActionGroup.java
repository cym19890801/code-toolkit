...
public class MainActionGroup extends ActionGroup {
    ...
    private AnAction[] getMenuList() {
        String mainActionId = "com.gsww.jdp.action.MainAction";
        String configActionId = "com.gsww.jdp.action.TableConfigAction";
        ...
        if (configAction == null) {
            configAction = new TableConfigAction("Config Table");
