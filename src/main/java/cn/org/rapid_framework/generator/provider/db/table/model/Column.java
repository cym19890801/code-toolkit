...
public class Column implements java.io.Serializable,Cloneable{
    ...
    private List<ExtColumn> exts = new ArrayList();
	...
	public Column(String sqlName, String jdbcType, String javaType, int size, String remarks){
		this._sqlName = sqlName;
		this.jdbcType = jdbcType;
		this.javaType = javaType;
		this._size = size;
		this._remarks = remarks;
		this.columnName = StringHelper.makeAllWordFirstLetterUpperCase(StringHelper.toUnderscoreName(sqlName));
	}
	...
	/**
	 * Gets the SqlType attribute of the Column2 object
	 * 
	...
	/**
	 * Gets the Table2 attribute of the DbColumn object
	 * 
	...
	/**
	 * Gets the SqlTypeName attribute of the Column2 object
	 * 
	...
	/**
	 * Gets the SqlName attribute of the Column2 object
	 * 
	...
	/**
	 * Gets the Pk attribute of the Column2 object
	 * 
	 * @return The Pk value
	 */
	public boolean isPk() {
	...
	/**
	 * Gets the Fk attribute of the Column2 object
	 * 
	 * @return The Fk value
	 */
	public boolean isFk() {
	...
	/**
	 * Gets the Nullable attribute of the Column2 object
	 * 
...
//			Table2 refTable = TableFactory.getInstance().getTable(hasOne.tableName);
...
//			Table2 refTable = TableFactory.getInstance().getTable(hasMany.tableName);
