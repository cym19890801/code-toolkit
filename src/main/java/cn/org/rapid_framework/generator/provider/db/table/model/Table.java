...
public class Table implements java.io.Serializable,Cloneable {
	...
	String className;
	String pageName;
	String _classNameLower="classNameLower";
	
	
	public String get_classNameLower() {
		return _classNameLower;
	}

	public void set_classNameLower(String _classNameLower) {
		this._classNameLower = _classNameLower;
	}
	...
	List<Column> otherColumns = new ArrayList<Column>();
	...
	public String getPageName() {
		String pageName=this.getSqlName().toLowerCase();
		System.out.println(pageName);
		System.out.println(pageName.replace("_", "-"));
	...
	public Column getPkColumn() {
		if(getPkColumns().isEmpty()) {
		    ...
		    logger.warn(MessageFormat.format("数据库表  {0} 没有主键",this.getSqlName()));
		    return getNotPkColumns().get(0);
		}
   ...
   public Column getRequiredColumnBySqlName(String sqlName) {
	 ...
	 * @param key
	 */
	public void addExportedKey(Map<Integer,Object> key) {
        getExportedKeys().addForeignKey(key.get(0).toString(),key.get(1).toString(),key.get(2).toString(),(Integer)key.get(3));
    }
	/**
	 * 增加导入外键
	 * @param key
	 */
	public void addImportedKey(Map<Integer,Object> key) {
	    getImportedKeys().addForeignKey(key.get(0).toString(),key.get(1).toString(),key.get(2).toString(),(Integer)key.get(3));
	}
	...
	public String toString() {
		return "Database Table2:"+getSqlName()+" to ClassName:"+getClassName();
	}
