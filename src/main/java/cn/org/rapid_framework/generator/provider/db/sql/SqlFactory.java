...
//    	String unscapedSourceSql = StringHelper.unescapeXml(beforeProcessedSql);
    ...
    public class SelectColumnsParser {
		...
		private Column newColumn(Table table, ResultSetMetaDataHolder m) {
			//Table2 table, int sqlType, String sqlTypeName,String sqlName, int size, int decimalDigits, boolean isPk,boolean isNullable, boolean isIndexed, boolean isUnique,String defaultValue,String remarks
